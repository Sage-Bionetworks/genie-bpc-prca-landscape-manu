...
*Implication if implemented:* For 114 of the 155 people we can find a time of metastasis.  The other 41 would not be a part of the metastatic cohort (no met noted).  The median time from diagnosis to met is 2 years.  I was expecting this to be higher than the time for those Stage I-III and it is (5 years for that group), so this seems reasonable at first pass.
