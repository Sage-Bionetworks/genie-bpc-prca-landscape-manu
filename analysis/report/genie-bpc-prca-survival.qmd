...
The appendix narrowly defines a few survival terms.  Looking there may help clarify what I mean in some places, and please ask if not.
...
*Todo:* Show risk set adjustment impact in the metastatic cohort.
...
- The difference between HRD and no HRD is not noticable in either the risk set adjusted graph or this one.
...
- **Risk set** The set of people capable of having the event of interest at a given time.  Specifically they must have entered the cohort.
  - **Adjusting the risk set** is the same as adjusting for left truncation assuming independent left truncation.
