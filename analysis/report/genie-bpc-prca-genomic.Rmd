...
Here's a plot that shows TMB vs TOMB and those cut points:
...
#   this is a sensitivity analysis.  This gets those in their axis order:
vec_genes_in_assoc_test <- dft_gene_assoc$var1_lab %>%
  levels(.) %>%
  str_replace_all(
    ., "[:space:].*", ""
  )
...
**Update:** Updated the definition of hypermuted to only include those with TOMB < 5.9 (TOMB = TMB only considering oncogenic mutations).
