...
### *R2.2 Alterations per sample

All I want to showcase here is that there are a few samples with dozens of alterations, and most samples have few to none (this plot does not include samples with zero alterations, but those can be added in).  Known but good to remember later.
...
### R2.3.2a Onco. impact by pathways - proportions
...
### *R2.3.2b Onco impact by pathways - counts
...
### *R2.3.2c Onco impact by DDR pathways - counts
...
### *R2.3.3 OncoKB levels of evidence
...
### *R2.3.4 OncoKB gain/loss of function
...
### R2.4.1a Alteration frequency by institution
...
### R2.4.1b Alteration frequency by institution (oncogenic)
...
### *R2.5.1 Co-occurence, top 10 genes
