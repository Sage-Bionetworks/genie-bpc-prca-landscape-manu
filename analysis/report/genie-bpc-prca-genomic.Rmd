...
dft_tmb <- dft_cpt |>
  ...
  ungroup() |>
  mutate(panel_lab = factor(
    paste0(cpt_seq_assay_id, " (n=", n_this_panel, ")")
  ))
...
### R2.5.1a Co-occurence, top 10 genes
...
### R2.5.1b Co-occurence, top 10 genes, sensitivity
