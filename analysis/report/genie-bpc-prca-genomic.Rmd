...
gg_tmb_dist <- ggplot(
  ...
  theme_classic() + 
  labs(
    title = "Tumor mutation burden by sample",
    subtitle = "One dot = one sample.  +0.1 added to all to include 0 TMB samples.",
