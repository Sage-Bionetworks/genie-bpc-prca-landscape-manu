...
dft_char_seq <- get_first_cpt(dft_ca_ind)
...
### R1.4a Observation counts (eCDF figure)
...
### R1.4b Observation counts (table)
...
This plot uses the "repeats removed" format for drug regimens, see R1.5f for more information.
...
- Trim the existing report content (R1.5c)
- 
...
A point from Ken Kehl on 8 May 2023:  For people who were never declared as CRPC or HSPC may never have seen a medical oncologist.  Can we look at stage or subsequent development of distant metastasis to see if that's the case?
